...
from routers import auth_router, products_router, depositors_router, warehouses_router, product_uoms_router, uom_definitions_router, zones_router, locations_router
